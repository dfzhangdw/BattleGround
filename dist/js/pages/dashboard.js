...
$(function () {
    ...
    var shangzhengRawData = rawData[1];
    var chuangyeRawData = rawData[2];
    var nuodechengzhangRawData = rawData[3];
    var guotaijuyouRawData = rawData[4];
    var shennongchengyuRawData = rawData[5];
  ...
  var lineChartRawData = {
      ...
      },
      {
          ...
          backgroundColor: window.chartColors.red,
          fill: false,
          data: shennongchengyuRawData,
          yAxisID: 'y-axis-2'
      }
      ]
  };

  var rawDataCtx = $("#rawDataCanvas")[0].getContext('2d');
  window.rawDataLine = Chart.Line(rawDataCtx, {
